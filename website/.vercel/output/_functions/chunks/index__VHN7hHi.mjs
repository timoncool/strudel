import { c8 as Pattern, cv as isPattern, ca as logger, aJ as scheduleAtTime, cw as getControlName, cb as noteToMidi, cx as ref } from './MiniRepl_Ntj7iAxy.mjs';
 ...
 * @license Apache-2.0
 */
let WebMidi$1 = class WebMidi extends EventEmitter {
 ...
 */
function defaultmidimap(mapping) {
...
export { WebMidi, defaultmidimap, enableWebMidi, midicontrolMap, midimaps, midin, midisoundMap };
