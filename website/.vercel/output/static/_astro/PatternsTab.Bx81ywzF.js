import{j as s}from"./jsx-runtime.CLpGMVip.js";import{g as u,u as m,c as C,d as h,e as F,f as c,h as f,j as y}from"./prebake.Cdsm-3G8.js";import{r as B}from"./index.B9mnsnPE.js";const A=`// Koji Kondo - Swimming (Super Mario World)
stack(
  seq(
    "~",
    "~",
...
.pianoroll({fold:1})`,v=`// Koji Kondo - Princess Zelda's Rescue
stack(
  // melody
...
.pianoroll({fold:1})
`,k=`// adapted from a Barry Harris excercise
"0,2,[7 6]"
  .add("<0 1 2 3 4 5 7 8>")
  .scale('C bebop major')
  .transpose("<0 1 2 1>/8")
...
//.pianoroll({fold:1})`,E=`// "Wavy kalimba"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
.clip(.5)
.piano()
.pianoroll()`,R=`// Hirokazu Tanaka - World 1-1
stack(
  // melody
  note(\`<
...
note(
  ...
  .gain(.5)
  .room(.5)
  .lpa(.125).lpenv(-2).v("8:.125").fanchor(.25)`,Y=`// "Festival of fingers 3"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
n("[-7*3],0,2,6,[8 7]")
  ...
  .slow(2).piano()
//.pianoroll({maxMidi:160})`,q=`// "Melting submarine"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
stack(
    ...
    .delayfeedback(.7)
    .orbit(2)
  ).sometimes(x=>x.speed("-1"))`,L=`// "Belldub"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
).reset("<x@7 x(5,8,-1)>")`,$=`// "Jux und tollerei"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
.note()
//.pianoroll()
.csound('CoolSynth')`,Z=`// "Lounge sponge"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
...
`,X=Object.freeze(Object.defineProperty({__proto__:null,amensister:U,arpoon:Q,barryHarris:k,bassFuge:M,belldub:L,blippyRhodes:G,caverave:w,chop:K,csoundDemo:V,delay:O,dinofunk:W,echoPiano:N,festivalOfFingers:S,festivalOfFingers3:Y,flatrave:J,giantSteps:x,goodTimes:_,holyflute:z,juxUndTollerei:$,loungeSponge:Z,meltingsubmarine:q,orbit:H,randomBells:T,sampleDemo:I,sampleDrums:D,sml1:R,swimming:A,undergroundPlumber:j,waa2:P,wavyKalimba:E,zeldasRescue:v},Symbol.toStringTag,{value:"Module"}));Object.fromEntries(Object.entries(X).map(([e,a],o)=>[o,{id:o,code:a,collection:"Stock Examples"}]));function b(...e){return e.filter(Boolean).join(" ")}function i({children:e,label:a,labelIsHidden:o,className:t,...l}){return s.jsxs("button",{className:b("hover:opacity-50 text-nowrap w-fit",t),title:a,...l,children:[o!==!0&&a,e]})}function ie(e){const{className:a,...o}=e;return s.jsx(i,{...o,className:b("bg-background p-2 max-w-[300px] rounded-md hover:opacity-50",a)})}function ee({label:e,className:a,...o}){return s.jsxs("label",{className:b("inline-flex items-center cursor-pointer",a),children:[s.jsx("input",{...o,className:"sr-only peer"}),s.jsx("span",{className:"inline-flex items-center peer-hover:opacity-50",children:e})]})}function re({className:e,...a}){return s.jsx(ee,{...a,className:e,label:s.jsx("span",{className:"bg-background p-2 max-w-[300px] rounded-md",children:a.label})})}function se({pattern:e}){const a=B.useMemo(()=>u(e.code),[e]);let o=a.title;if(o==null){const l=new Date(e.created_at);isNaN(l)?o="без названия":o=l.toLocaleDateString()}const t=Array.isArray(a.by)?a.by.join(","):"Аноним";return s.jsx(s.Fragment,{children:`${e.id}: ${o} by ${t.slice(0,100)}`.slice(0,60)})}function ae({showOutline:e,onClick:a,pattern:o,showHiglight:t}){return s.jsx("a",{className:b("mr-4 hover:opacity-50 cursor-pointer block",e&&"outline outline-1",t&&"bg-selection"),onClick:a,children:s.jsx(se,{pattern:o})})}function oe({patterns:e,activePattern:a,onClick:o,started:t}){const l=h(),p=F(l).id;return s.jsx("div",{className:"",children:Object.values(e).reverse().map(r=>{const n=r.id;return s.jsx(ae,{pattern:r,showHiglight:n===p,showOutline:n===a&&t,onClick:()=>o(n)},n)})})}const d=(e,a,o=!1)=>{e.handleUpdate(a,o)};function ne({context:e}){const a=C(),o=h(),t=F(o),{userPatterns:l,patternFilter:g,patternAutoStart:p}=m(),r=t?.id;return s.jsxs("div",{className:"flex flex-col gap-2 flex-grow overflow-hidden h-full pb-2 ",children:[s.jsxs("div",{className:"pr-4 space-x-4  flex max-w-full overflow-x-auto",children:[s.jsx(i,{label:"новый",onClick:()=>{const{data:n}=c.createAndAddToDB();d(e,n)}}),s.jsx(i,{label:"копировать",onClick:()=>{const{data:n}=c.duplicate(t);d(e,n)}}),s.jsx(i,{label:"удалить",onClick:()=>{const{data:n}=c.delete(r);d(e,{...n,collection:c.collection})}}),s.jsxs("label",{className:"hover:opacity-50 cursor-pointer",children:[s.jsx("input",{style:{display:"none"},type:"file",multiple:!0,accept:"text/plain,text/x-markdown,application/json",onChange:n=>f(n.target.files)}),"импорт"]}),s.jsx(i,{label:"экспорт",onClick:y}),s.jsx(i,{label:"удалить все",onClick:()=>{const{data:n}=c.clearAll();d(e,n)}})]}),s.jsx("div",{className:"overflow-auto h-full bg-background p-2 rounded-md",children:s.jsx(oe,{onClick:n=>{d(e,{...l[n],collection:c.collection},p),e.started&&a===n&&e.handleEvaluate()},patterns:l,started:e.started,activePattern:a,viewingPatternID:r})})]})}function de({context:e}){return m(),s.jsx("div",{className:"px-4 w-full text-foreground  space-y-2  flex flex-col overflow-hidden max-h-full h-full",children:s.jsx(ne,{context:e})})}export{i as A,se as P,re as S,ie as a,de as b,b as c};
