import { ce as parseNumeral, cf as isNote, cb as noteToMidi, cg as register, ca as logger, cd as ClockCollator } from './MiniRepl_Ntj7iAxy.mjs';
 ...
 * @returns Pattern
 */
const osc = register('osc', (pat) => pat.onTrigger(oscTrigger));

export { osc, oscTrigger, parseControlsFromHap };
