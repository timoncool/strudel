...
<!-- MINIREPL_START -->".add("<48 53>")).room(.5)`} />
...
<!-- MINIREPL_START -->").voicing().room(.5)`} punchcard />
...
<!-- MINIREPL_START -->").chord("C").voicing().room(.5)`} punchcard />
...
<!-- MINIREPL_START -->").chord("C").anchor("c5").voicing().room(.5)`}
  punchcard
/>
...
<!-- MINIREPL_START -->:c5").chord("C").voicing().room(.5)`} punchcard />
