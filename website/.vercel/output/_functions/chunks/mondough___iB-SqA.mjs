import { ci as registerLanguage, cj as silence, c6 as reify, ck as strudelScope, cl as stepcat, cm as fast, cn as slow, co as replicate, cp as expand, cq as pace, cr as degradeBy, cs as bjork, ct as chooseIn, cu as seq } from './MiniRepl_Ntj7iAxy.mjs';
...
const mondolang = (code) => mondo(code, 0);
...
export { getLocations, mondi, mondo, mondolang };
