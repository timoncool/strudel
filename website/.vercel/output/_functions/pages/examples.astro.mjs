/* empty css                                  */
import { c as createComponent, r as renderTemplate, b as renderComponent, g as renderHead, f as addAttribute } from '../chunks/astro/server_Cr1ImhJZ.mjs';
...
const blippyRhodes = `// "Blippy Rhodes"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
const wavyKalimba = `// "Wavy kalimba"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
const festivalOfFingers = `// "Festival of fingers"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
// iter, echo, echoWith
const undergroundPlumber = `// "Underground plumber"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
const randomBells = `// "Random bells"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
const festivalOfFingers3 = `// "Festival of fingers 3"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
const meltingsubmarine = `// "Melting submarine"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
const juxUndTollerei = `// "Jux und tollerei"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
const loungeSponge = `// "Lounge sponge"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<head>${renderComponent($$result, "HeadCommon", $$HeadCommon, {})}${renderHead()}</head> <body class="bg-slate-800"> <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-2 p-2 select-none"> ${Object.entries(tunes).map(([name, tune]) => renderTemplate`<a class="rounded-md bg-slate-900 hover:bg-slate-700 cursor-pointer relative block w-full h-[160px]"${addAttribute(`${baseNoTrailing}/#${btoa(tune)}`, "href")}> <div class="absolute w-full h-full flex justify-center items-center"> <span class="bg-slate-800 p-2 rounded-md text-white">${getMetadata(tune)["title"] || name}</span> </div> </a>`)} </div>
../../metadata_parser</body>`;
}, "/home/user/Bulka/website/src/pages/examples/index.astro", undefined);
const $$file = "/home/user/Bulka/website/src/pages/examples/index.astro";
const $$url = "/examples";
