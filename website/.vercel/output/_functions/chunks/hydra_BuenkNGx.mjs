import { g as getDrawContext, c4 as speed, c5 as shape, c6 as reify, c7 as getTime } from './MiniRepl_Ntj7iAxy.mjs';

let latestOptions;
let hydra;

async function initHydra(options = {}) {
...
const H = (p) => () => reify(p).queryArc(getTime(), getTime())[0].value;

export { H, clearHydra, initHydra };
